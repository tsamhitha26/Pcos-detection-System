...
def predict_all():
    ...
    return jsonify({
        ...
        "final_combined_score": final_prob,
        "pcos_risk": risk,
        "model_used": model_used
    })

if __name__ == '__main__':
    app.run(host='10.10.5.166', port=5000, debug=True)
